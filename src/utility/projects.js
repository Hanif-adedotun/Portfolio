...
export const applications=[
     {
          ...
          'summary': 'The Taxi Ordering App is a sleek and user-friendly Java application designed to facilitate secure and convenient online ride bookings. It was developed as part of my coursework in Object-Oriented Programming Course.',
          'tools': ['Java Swing', 'GNU Compiler', 'Java']
     },
     {
          'img': Bluegram,
          'name': ['Bluegram','https://github.com/Hanif-adedotun/Java-Taxi-App'],
          'summary': 'Bluegram is an innovative no-code Android application developed solely on a mobile device. It serves as a Bluetooth messaging app that enables users to exchange messages without relying on mobile data, as long as they are in proximity through a Bluetooth connection. The aim of Bluegram was to revolutionize communication within a localized setting, eliminating the dependency on mobile data for real-time conversations with individuals sharing the same building or vicinity.',
